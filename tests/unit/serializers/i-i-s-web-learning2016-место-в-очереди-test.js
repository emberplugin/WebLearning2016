...
moduleForModel('i-i-s-web-learning2016-место-в-очереди', 'Unit | Serializer | i-i-s-web-learning2016-место-в-очереди', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-web-learning2016-место-в-очереди',
    'transform:file',
    'transform:decimal',
    'transform:guid',
